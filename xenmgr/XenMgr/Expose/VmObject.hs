...
implementationFor xm uuid = self where
  ...
  , comCitrixXenclientXenmgrVmUnrestrictedGetAcpiTable = getVmAcpiTable uuid
  , comCitrixXenclientXenmgrVmUnrestrictedSetAcpiTable = \v -> setVmAcpiTable uuid v
  ...
  , comCitrixXenclientXenmgrVmUnrestrictedGetInitFlaskLabel = getVmInitFlaskLabel uuid
  , comCitrixXenclientXenmgrVmUnrestrictedSetInitFlaskLabel = setVmInitFlaskLabel uuid
  , comCitrixXenclientXenmgrVmUnrestrictedGetStubdomFlaskLabel = getVmStubdomFlaskLabel uuid
  , comCitrixXenclientXenmgrVmUnrestrictedSetStubdomFlaskLabel = setVmStubdomFlaskLabel uuid
  ...
  , comCitrixXenclientXenmgrVmGetAcpiTable = getVmAcpiTable uuid
  , comCitrixXenclientXenmgrVmSetAcpiTable = \v -> restrict >> setVmAcpiTable uuid v
  ...
  , comCitrixXenclientXenmgrVmGetInitFlaskLabel = getVmInitFlaskLabel uuid
  , comCitrixXenclientXenmgrVmSetInitFlaskLabel = \v -> restrict >> setVmInitFlaskLabel uuid v
  , comCitrixXenclientXenmgrVmGetStubdomFlaskLabel = getVmStubdomFlaskLabel uuid
  , comCitrixXenclientXenmgrVmSetStubdomFlaskLabel = \v -> restrict >> setVmStubdomFlaskLabel uuid v
